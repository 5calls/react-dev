...
This repo is designed to as a starting point for the port of the 5 Calls web site from the [Choo](https://choo.io) front-end framework to [React](https://facebook.github.io/react/) with [Redux](http://redux.js.org/) for state management and [Typescript](https://www.typescriptlang.org/) for type safety and documentation.
...
# any updates to .scss files need to be compiled to css using:
yarn build-css
...
* **react-scripts-ts:** Used version 2.2.0 to create the app, which was up-to-date with CRA react-scripts version 1.0.0.
...
------------------------------------------
## What follows is the original CRA documentation
------------------------------------------
